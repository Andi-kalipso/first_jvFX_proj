...
public class Main  extends Application {
    ...
    public void start(Stage stage) throws IOException {
        FXMLLoader fxmlLoader = new FXMLLoader(Main.class.getResource("Main-view.fxml"));     //вставляем сюда окно вида на fxml (css)
        Scene scene = new Scene(fxmlLoader.load(), 1600, 900);                               //настройки сцены
